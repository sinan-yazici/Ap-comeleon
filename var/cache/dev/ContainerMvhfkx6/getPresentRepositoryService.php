 ...
 */
class getPresentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PresentRepository' shared autowired service.
     *
     * @return \App\Repository\PresentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PresentRepository.php';

        return $container->privates['App\\Repository\\PresentRepository'] = new \App\Repository\PresentRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
